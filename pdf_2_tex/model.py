...
#                     # print("pos_bias_older_original: ",pos_bias.shape)
#                     # input("Press Enter to continue...")

#                     # print("Swin-State-Shape:", pos_bias.shape)
#                     # print()
#                     # print("Swin-state_dict:  ",swin_state_dict[x].shape)
...
#                     # print("Pos_bias before reshaping: ",pos_bias.shape)
#                     pos_bias = pos_bias.reshape(1, old_len, old_len, -1).permute(
#                         0, 3, 1, 2
#                     )
#                     # print("pos_bias after reshaping: ",pos_bias.shape)
...
#                         align_corners=False,
#                     )
#                     # print("pos_bias after interpolation: ",pos_bias.shape)
...
#                         .squeeze(0)
#                     )
#                     # print("new_swin_state_dict[x]: ",new_swin_state_dict[x])
#                     # print("new_swin_state_dict[x]_shape: ",new_swin_state_dict[x].shape)
#                 else:
